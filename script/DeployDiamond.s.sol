...
contract DeployDiamond is Script {
    ...
    function _getEventCoreSelectors() internal pure returns (bytes4[] memory selectors) {
        ...
        selectors[4] = EventCoreFacet.setAlgorithm1.selector;
        selectors[5] = EventCoreFacet.lockAlgorithm.selector;
        selectors[6] = EventCoreFacet.setResaleRules.selector;
        selectors[7] = EventCoreFacet.cancelEvent.selector;
        selectors[8] = EventCoreFacet.markEventCompleted.selector;
        selectors[9] = EventCoreFacet.getTicketNFT.selector;
        selectors[10] = EventCoreFacet.getEventInfo.selector;
        selectors[11] = EventCoreFacet.getEventStatus.selector;
    }
